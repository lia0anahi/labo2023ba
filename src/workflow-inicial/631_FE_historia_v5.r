...
PARAM <- list()
PARAM$experimento <- "FE6310_v5"

PARAM$exp_input <- "DR6210_v5"
...
PARAM$RandomForest$semilla <- 100103 # cambiar por la propia semilla


# varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$ratio <- 1.08
# desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$desvios <- 60
# cambiar por la propia semilla
PARAM$CanaritosAsesinos$semilla <- 100103
